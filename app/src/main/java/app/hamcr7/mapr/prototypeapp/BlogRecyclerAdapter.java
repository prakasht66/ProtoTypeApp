...
public class BlogRecyclerAdapter extends RecyclerView.Adapter<BlogRecyclerAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_blog_single, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setTitText(String titText){
            ...
            titView = mView.findViewById(R.id.blog_tit);
            titView.setText(titText);
        }
        public void setCatText(String catText){

            catView = mView.findViewById(R.id.cad_category);
            catView.setText(catText);
