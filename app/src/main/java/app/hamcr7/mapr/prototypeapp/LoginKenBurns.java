...
public class LoginKenBurns extends AppCompatActivity {

    Fragment frag_login,frag_Discussion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_ken_burns);
        ...
        frag_Discussion=new DiscussionFrag();
            ...
            public void onClick(View p1) {
                ...
                button_login.animate().setInterpolator(new FastOutSlowInInterpolator()).setStartDelay(4000).setDuration(1000).scaleX(30).scaleY(30).setListener(new Animator.AnimatorListener(){
                    ...
                    public void onAnimationEnd(Animator p1) {
                        try{
                            //getFragmentManager().beginTransaction().replace(R.id.frag_container,DiscussionFrag).disallowAddToBackStack().commitAllowingStateLoss();
                            getSupportFragmentManager().beginTransaction().replace(R.id.frag_container,frag_Discussion).disallowAddToBackStack().commitAllowingStateLoss();
                        }catch(Exception e){}
